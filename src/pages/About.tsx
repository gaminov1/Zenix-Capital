        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4">
              The Zenix Capital Difference
            </h2>
            <p className="text-lg md:text-xl text-gray-600 max-w-3xl mx-auto">
              Real estate needs and expectations might've changed, but the
              challenge remains the same – businesses need clarity and best
              judgement to connect the ideas, people and places that make them
              successful.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
            ...
            <div className="bg-white p-8 rounded-lg shadow-xl hover:shadow-2xl transition-shadow duration-300 text-center border border-gray-100">
              ...
              <p className="mt-4 text-lg text-gray-700">PEOPLE</p>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-12 items-center">
            ...
            <div className="w-full lg:w-1/2">
              ...
              <div className="space-y-6 text-lg text-gray-700">
                <p>
                  Zenix Capital was founded with a single purpose: to empower
                  entrepreneurs and small business owners by providing
                  accessible, transparent, and fast capital solutions. We
                  understand the challenges faced by growing businesses, because
                  we've been there ourselves.
                </p>

                <p>
                  From global real estate investors to specialist developers,
                  distribution giants to biotech start-ups, Zenix Capital
                  advises the businesses that are driving the economy, creating
                  jobs and harnessing innovation. Combining our expertise with
                  best-in-class market intelligence and data enables us to build
                  bespoke strategies to achieve our clients' objectives.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className="bg-gray-900 bg-opacity-50 backdrop-blur-sm border border-gray-800 rounded-2xl p-10 transition-all duration-500 hover:border-blue-500 hover:shadow-xl hover:shadow-blue-900/20">
                ...
                <p className="text-gray-300 text-lg leading-relaxed">
                  Zenix Funding's success is built upon our unique and strategic
                  approach to teamwork, building custom-fit teams capable of
                  best servicing our clients. We incentivize collaboration and
                  ensure everyone has a voice and is supported to achieve their
                  potential.
                </p>
              </div>
            ...
            <div className="bg-white/90 p-8 sm:p-10 rounded-xl backdrop-blur-sm shadow-sm mx-auto text-center">
              ...
              <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mb-4 leading-tight">
                ...
                <span className="text-blue-600 mb-4">
                  The Zenix Funding Advantage.
                </span>
              </h1>

              {/* Centered Paragraph */}
              <p className="text-base md:text-lg text-gray-700 mb-8 max-w-2xl mx-auto leading-relaxed">
                At Zenix Funding, we go beyond traditional financing by offering
                tailored solutions designed to meet your business goals. With
                fast approvals, flexible terms, and a team that truly
