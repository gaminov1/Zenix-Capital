          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8">
              <h2 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight">
                ...
                <span className="text-[#5BA7F9]">say about us</span>
              </h2>
              ...
              <div className="relative">
                <blockquote className="text-xl text-gray-600 leading-relaxed pl-8 border-l-4 border-[#5BA7F9]">
                  ...
                  honestly and professionally. After applying, he got me funds
                  within one day, and it was surprisingly simple!"
                </blockquote>
              </div>
              ...
              <div className="space-y-1">
                ...
                <div className="text-gray-500">
                  Satisfied Zenix Capital Client
                </div>
              </div>

              <div className="pt-4">
                <Button className="bg-[#5BA7F9] hover:bg-[#4A96E8] text-white px-8 py-6 text-lg font-semibold transition-all duration-300 hover:shadow-lg">
                  About Zenix Capital
